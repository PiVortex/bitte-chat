...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "bitte-border-t bitte-bg-muted/50 bitte-font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "bitte-border-b bitte-transition-colors bitte-hover:bg-muted/50 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />

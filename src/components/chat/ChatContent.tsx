...
export const ChatContent = ({
  ...
  return (
    <div className='bitte-flex bitte-h-full bitte-w-full bitte-flex-col bitte-gap-4 bitte-text-justify'>
      <div
        className='bitte-relative bitte-flex bitte-min-h-[200px] lg:bitte-min-h-[400px] bitte-w-full bitte-h-full bitte-grow-0 bitte-overflow-y-auto bitte-rounded-md bitte-max-lg:flex-col bitte-border lg:bitte-px-6'
        style={{
      ...
      <div
        className='bitte-z-10 bitte-rounded-md bitte-border bitte-p-6'
        style={{
          backgroundColor: generalBackground,
          borderColor: borderColor,
        }}
